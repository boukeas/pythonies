...
\newmintedfile[pyfilenew]{python3}{linenos=true,numberblanklines=false,escapeinside=||,bgcolor=codebg}
% pyfilenew: python από αρχείο (υφιστάμενος κώδικας)
\newmintedfile[pyfileplain]{python3}{linenos=true,numberblanklines=false,escapeinside=||,bgcolor=white}
...
\newcommand{\solutionlink}[2]{
    \\\mbox{}\vspace{-\parskip}\hfill{\scriptsize\textup{\repositorylink{#1}{exercises}{#2}}}}
