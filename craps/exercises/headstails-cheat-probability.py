...
while True:
    ...
    # τυχαία επιλογή έκβασης παιχνιδιού
    # αν η win ξεπερνά το 90, μόνο τότε ο παίκτης κερδίζει
    win = random.randint(1,100)
    if win > 90:
        # ο παίκτης θα κερδίσει: χωρίς να κληθεί η flip(), 
        # ανακοινώνεται ως αποτέλεσμα η ίδια επιλογή
        # με εκείνη του παίκτη
        if player == 0:
