...
h1 = h1 // 2    # παίρνει από τον πρώτο σωρό τα μισά σπίρτα
h3 = h3 + h1    # και τα επιστρέφει στον τρίτο σωρό.
print("Αντίστροφα, από τον 1ο σωρό στον 3ο:", h1, h2, h3)

h3 = h3 // 2    # παίρνει από τον τρίτο σωρό τα μισά σπίρτα
h2 = h2 + h3    # και τα επιστρέφει στον δεύτερο σωρό.
print("Αντίστροφα, από τον 3ο σωρό στον 2ο:", h1, h2, h3)

h2 = h2 // 2    # παίρνει από τον δεύτερο σωρό τα μισά σπίρτα
h1 = h1 + h2    # και τα επιστρέφει στον πρώτο σωρό.
print("Αντίστροφα, από τον 2ο σωρό στον 1ο:", h1, h2, h3)

print("\nΑπάντηση. Αρχική κατάσταση:", h1, h2, h3, end="\n\n")

h1 = h1 - h2    # παίρνει από τον πρώτο σωρό όσα σπίρτα υπάρχουν στο δεύτερο
h2 = 2 * h2     # και τα προσθέτει στον δεύτερο σωρό.
print("Επαλήθευση, από τον 1ο σωρό στον 2ο:", h1, h2, h3)

h2 = h2 - h3    # παίρνει από τον δεύτερο σωρό όσα σπίρτα υπάρχουν στον τρίτο
h3 = 2 * h3     # και τα προσθέτει στον τρίτο σωρό.
print("Επαλήθευση, από τον 2ο σωρό στον 3ο:", h1, h2, h3)

h3 = h3 - h1    # παίρνει από τον τρίτο σωρό όσα σπίρτα υπάρχουν στον πρώτο
h1 = h1 * 2     # και τα προσθέτει στον πρώτο σωρό.
