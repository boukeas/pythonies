...
Το ενδιαφέρον με την συγκεκριμένη εκδοχή της λύσης είναι η χρήση της else στη while. Οι εντολές της else εκτελούνται όταν η συνθήκη που ελέγχεται από τη while είναι πια ψευδής, δηλαδή όταν η επανάληψη τερματιστεί "φυσιολογικά" (όχι από μια break). 
'''
...
while tries > 1:
    ...
    # οι εντολές της else θα εκτελεστούν όταν tries = 0 και εφόσον 
    # η επανάληψη δεν έχει προηγουμένως διακοπεί από break,
    # δηλαδή όταν ο χρήστης φτάσει στην τελευταία του προσπάθεια
    # χωρίς προηγουμένως να έχει εντοπίσει τον μυστικό αριθμό
    #
    # εμφάνιση και μείωση προσπαθειών
