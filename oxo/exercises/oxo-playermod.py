...
Όταν θελήσαμε να τροποποιήσουμε το πρόγραμμα ώστε να εμφανίζει το
...
board = 9 * [" "]
# [τροποποιήθηκε] ο παίκτης που *δεν* θα παίξει πρώτος
player = "O"
...
while blank > 0 and not inarow:
    # [μετακινήθηκε στην αρχή της επανάληψης] εναλλαγή παίκτη
    player = next(player)
    # επιλογή θέσης
    if player == computer:
...
print3x3(board)
# [τροποποιήθηκε] εμφάνιση αποτελέσματος
if inarow:
