...
Να υλοποιήσετε την συνάρτηση readMatches() χρησιμοποιώντας μόνο
...
def readMatches(p,m):
    ...
    limit = maxMatches(m)
    # επαναληπτικός έλεγχος: η επανάληψη θα σταματά με χρήση της εντολής break
    # όταν ο αριθμός των σπίρτων είναι έγκυρος
    while True:
        ...
        if num < 1 or num > limit:
            ...
            # διαφορετικά, διακόπτεται η επανάληψη
            break
